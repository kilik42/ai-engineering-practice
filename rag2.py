...
# Preferred variable name used by the Anthropic SDK/LangChain integration.
# For compatibility with your original tutorial, API_KEY is also accepted.
...
# Your original file used an old Claude 3.5 Sonnet model name.
# This example uses a currently active Claude Sonnet model.
llm = ChatAnthropic(
...
def ask_rag(question: str) -> dict:
    ...
    send the grounded prompt to Claude, and return both the answer
